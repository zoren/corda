    ...
    open class Seller(val otherParty: Party,
        ...
        private fun receiveAndCheckProposedTransaction(): SignedTransaction {
            ...
            maybeSTX.unwrap {
                ...
                checkData(wtx.outputs.map { it.data }.sumCashBy(myPublicKey).withoutIssuer() == price) {
        ...
        // DOCEND 5
        // There are all sorts of funny games a malicious secondary might play with maybeSTX, we should fix them:
        //
