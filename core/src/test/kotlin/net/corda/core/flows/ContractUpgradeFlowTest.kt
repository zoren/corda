...
class ContractUpgradeFlowTest {
    ...
    fun `upgrade Cash to v2`() {
        ...
        val result = a.services.startFlow(CashIssueFlow(Amount(1000, USD), OpaqueBytes.of(1), chosenIdentity, notary, anonymous)).resultFuture
        mockNet.runNetwork()
        ...
        assertEquals<Collection<AbstractParty>>(listOf(chosenIdentity), (firstState.state.data as CashV2.State).owners, "Upgraded cash belongs to the right owner.")
    }
